...
class Activity_Model_DbTable_Actions extends Engine_Db_Table
{
   ...
   * start customization
   */
  public function getActionsByObjectAndType(Core_Model_Item_Abstract $object, $type) {
  ...
  public function getActionsByAttachmentAndType(Core_Model_Item_Abstract $attachment, $type)
  {
