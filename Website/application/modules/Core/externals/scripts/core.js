...
en4.core.comments = {
  ...
  attachCreateComment : function(formElement, guid){
    var bind = this;
...
//         	
  ...
  comment : function(type, id, body, guid){
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'core/comment/create',
      data : {
        format : 'json',
  ...
  like : function(type, id, comment_id, guid) {
  	var imgEle = new Element('div', {
      	class : 'activity_ajax_loader',
      	html: '&nbsp;',      	
    });
    imgEle.inject($('comments-' + guid).getElement('ul'), 'top');
    en4.core.request.send(new Request.JSON({
  ...
  unlike : function(type, id, comment_id, guid) {
  	var imgEle = new Element('div', {
      	class : 'activity_ajax_loader',
      	html: '&nbsp;',      	
    });
    console.log(guid);
    console.log($('comments-' + guid));
    imgEle.inject($('comments-' + guid).getElement('ul'), 'top');
    en4.core.request.send(new Request.JSON({
  ...
  showLikes : function(type, id, guid){
    en4.core.request.send(new Request.HTML({
      url : en4.core.baseUrl + 'core/comment/list',
      data : {
        format : 'html',
