	...
	<body id="image" style="display: none">
		<div class="tabs">
			<ul>
				...
				echo'current' ?>">
					<span><a href="<?php echo $this -> baseUrl() . '/externals/tinymce/themes/advanced/image.htm'; ?>" onmousedown="return false;">{#advanced_dlg.image_title}</a></span>
				</li>
				<li id="general_tab" class="<?php if (!$this->status)
				echo'current' ?>">
					<span><a href="<?php echo $this -> baseUrl() . '/externals/tinymce/themes/advanced/upload.htm'; ?>" onmousedown="return false;">Upload</a></span>
				</li>
			</ul>
		</div>

		<form class="myform" onsubmit="ImageDialog.update();return false;" action="#" 
			style="<?php if (!$this->status) echo'display:none;' ?>">
				...
				<div id="general_panel" class="panel current">
					<table border="0" cellpadding="4" cellspacing="0">
						<tr>
							...
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<input id="src" name="src" type="text" class="mceFocus" value="<?php
											if ($this -> photo_url)
												echo $this -> photo_url;
	 										?>" style="width: 200px" onchange="ImageDialog.getImageData();" />
										</td>
						...
						<tr>
							...
							<td>
								<input id="width" name="width" type="text" value="<?php echo $this->photo_width?>" size="3" maxlength="5" />
								x
								<input id="height" name="height" type="text" value="<?php echo $this->photo_height?>" size="3" maxlength="5" />
							</td>
						</tr>
						<tr>
							<td class="nowrap"><label for="border">{#advanced_dlg.image_border}</label></td>
							<td>
								<input id="border" name="border" type="text" value="" size="3" maxlength="3" onchange="ImageDialog.updateStyle();" />
							</td>
						</tr>
						<tr>
							<td class="nowrap"><label for="vspace">{#advanced_dlg.image_vspace}</label></td>
							<td>
								<input id="vspace" name="vspace" type="text" value="" size="3" maxlength="3" onchange="ImageDialog.updateStyle();" />
							</td>
						</tr>
						<tr>
							<td class="nowrap"><label for="hspace">{#advanced_dlg.image_hspace}</label></td>
							<td>
								<input id="hspace" name="hspace" type="text" value="" size="3" maxlength="3" onchange="ImageDialog.updateStyle();" />
							</td>
						</tr>
					</table>
				</div>
		...
		<div id="upload_panel" class="panel_wrapper" style="height: 200px;<?php if ($this->status) echo'display:none;' ?>">
			<?php echo $this->translate('The image you tried to upload failed. Please try ')?><a href="<?php echo $this -> baseUrl() . '/externals/tinymce/themes/advanced/upload.htm'; ?>">again</a>.
		</div>
