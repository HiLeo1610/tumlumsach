...
<div class='layout_middle'>
	<div class="generic_layout_container">
		<div class='networks_left'>
			<h3>
			<?php echo $this->translate('Available Networks');?>
			</h3>
			...
			<?php foreach ($this->network_suggestions as $network): ?>
				<li>
					...
					<?php echo $network->title ?>
						<span>(<?php echo $this->translate(array('%s member.', '%s members.', $network->membership()->getMemberCount()),$this->locale()->toNumber($network->membership()->getMemberCount())) ?>)
						</span>
					</div> <?php if( $network->assignment == 0 ): ?> <a
					href='javascript:void(0);'
					onclick="joinNetwork(<?php echo $network->network_id;?>)"><?php echo $this->translate('Join Network');?>
				</a> <?php endif; ?>
				</li>
				<?php endforeach; ?>
			</ul>
			...
			<?php else:?>
			<div class="tip">
				<span><?php echo $this->translate('There are currently no avaliable networks to join.');?>
				</span>
			</div>
		...
		<div class='networks_right'>
			<h3>
			<?php echo $this->translate('My Networks');?>
			</h3>
			<p>
			...
			<?php foreach ($this->networks as $network): ?>
				<li>
					...
					href='javascript:void(0);'
					onclick="leaveNetwork(<?php echo $network->network_id;?>)"><?php echo $this->translate('Leave Network');?>
				</a> <?php endif; ?>
				</li>
				<?php endforeach; ?>
			</ul>
